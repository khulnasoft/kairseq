...
import kairseq.distributed.utils as distributed_utils
from kairseq import options, utils
from kairseq.data import Dictionary
from kairseq.data.language_pair_dataset import collate
...
from kairseq.models.kairseq_encoder import EncoderOut
from kairseq.tasks import LegacyKairseqTask
from kairseq_cli import generate, interactive, preprocess, train, validate
...
class TestTranslationTask(LegacyKairseqTask):
...
class TestModel(KairseqEncoderDecoderModel):
...
class TestEncoder(KairseqEncoder):
...
class TestIncrementalDecoder(KairseqIncrementalDecoder):
    def __init__(self, args, dictionary):
        super().__init__(dictionary)
...
class TestReshapingEncoder(KairseqEncoder):
    def __init__(self, args, dictionary):
        super().__init__(dictionary)
        self.args = args
...
class TestReshapingModel(KairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)
...
class TestAdditionalInputEncoder(KairseqEncoder):
    def __init__(self, args, dictionary):
        super().__init__(dictionary)
        self.args = args
...
class TestAdditionalInputModel(KairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)
