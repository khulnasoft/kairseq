...
from kairseq.scoring.wer import WerScorer
from kairseq.scoring.bleu import SacrebleuScorer
from kairseq import utils
import zipfile

S3_BASE_URL = "https://dl.fbaipublicfiles.com/kairseq"


class TestKairseqSpeech(unittest.TestCase):
    @classmethod
    ...
    def _set_up(self, dataset_id: str, s3_dir: str, data_filenames: List[str]):
        ...
        self.root = Path.home() / ".cache" / "kairseq" / dataset_id
