...
from .asr_test_base import (
    ...
    TestKairseqDecoderBase,
    TestKairseqEncoderBase,
    TestKairseqEncoderDecoderModelBase,
...
class VGGTransformerModelTest_mid(TestKairseqEncoderDecoderModelBase):
    def setUp(self):
...
class VGGTransformerModelTest_big(TestKairseqEncoderDecoderModelBase):
    def setUp(self):
        def override_config(args):
            """
...
class VGGTransformerModelTest_base(TestKairseqEncoderDecoderModelBase):
    def setUp(self):
        def override_config(args):
            """
...
class VGGTransformerEncoderTest(TestKairseqEncoderBase):
    def setUp(self):
        super().setUp()
...
class TransformerDecoderTest(TestKairseqDecoderBase):
    def setUp(self):
        super().setUp()
