...
from kairseq.dataclass.configs import (
    CheckpointConfig,
    CommonConfig,
    CommonEvalConfig,
    DatasetConfig,
...
from kairseq.utils import csv_str_list, eval_bool, eval_str_dict, eval_str_list  # noqa
...
def parse_args_and_arch(
    ...
    from kairseq.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY, MODEL_REGISTRY
    ...
    if getattr(args, "use_bmuf", False):
        ...
        from kairseq.optim.bmuf import KairseqBMUF

        KairseqBMUF.add_args(parser)
...
def get_parser(desc, default_task="translation"):
    ...
    # Task definitions can be found under kairseq/tasks/
    from kairseq.tasks import TASK_REGISTRY
...
def add_model_args(parser):
    ...
    # Model definitions can be found under kairseq/models/
    #
