...
from kairseq.criterions import register_criterion
from kairseq.criterions.ctc import CtcCriterion
from kairseq.criterions.label_smoothed_cross_entropy_with_rdrop import (
    RdropLabelSmoothedCrossEntropyCriterion,
    RdropLabelSmoothedCrossEntropyCriterionConfig,
    duplicate_input,
)
from kairseq.criterions.tacotron2_loss import (
    Tacotron2Criterion,
