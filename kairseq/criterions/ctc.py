...
from kairseq.criterions import KairseqCriterion, register_criterion
...
@dataclass
class CtcCriterionConfig(KairseqDataclass):
    ...
    post_process: str = field(
        ...
        metadata={
            ...
            "See kairseq.data.data_utils.post_process() for full list of options"
        },
    )
...
class CtcCriterion(KairseqCriterion):
    def __init__(
        self, cfg: CtcCriterionConfig, task: KairseqTask, rdrop_alpha: int = 0.0
    ):
        super().__init__(task)
        self.blank_idx = (
