...
@dataclass
class SpeechUnitLmCriterionConfig(KairseqDataclass):
...
class SpeechUnitLmCriterion(KairseqCriterion):
    def __init__(self, cfg: SpeechUnitLmCriterionConfig, task: KairseqTask):
        super().__init__(task)
