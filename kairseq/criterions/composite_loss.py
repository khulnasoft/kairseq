...
from kairseq.criterions import LegacyKairseqCriterion, register_criterion
from torch import nn


@register_criterion("composite_loss")
class CompositeLoss(LegacyKairseqCriterion):
    ...
    def build_criterion(cls, args, task):
        ...
        class _CompositeLoss(LegacyKairseqCriterion):
