...
from kairseq.data.data_utils import lengths_to_mask
from kairseq.models.kairseq_model import KairseqEncoderModel


@dataclass
class FastSpeech2CriterionConfig(KairseqDataclass):
...
class FastSpeech2Loss(KairseqCriterion):
    def __init__(self, task, ctc_weight):
        super().__init__(task)
        self.ctc_weight = ctc_weight

    def forward(self, model: KairseqEncoderModel, sample, reduction="mean"):
