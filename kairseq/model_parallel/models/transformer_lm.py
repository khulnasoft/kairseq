...
from kairseq.model_parallel.models.transformer import ModelParallelTransformerDecoder
...
try:
    from kairseq.model_parallel.megatron.mpu import VocabParallelEmbedding
