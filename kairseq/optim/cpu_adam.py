...
@dataclass
class KairseqCPUAdamConfig(KairseqDataclass):
...
@register_optimizer("cpu_adam", dataclass=KairseqCPUAdamConfig)
class KairseqCPUAdam(KairseqOptimizer):
    """Adam optimizer for kairseq, optimized for CPU tensors.
