...
from kairseq.dataclass.configs import KairseqBMUFConfig
from kairseq.dataclass.utils import gen_parser_from_dataclass
from kairseq.optim.kairseq_optimizer import KairseqOptimizer


class KairseqBMUF(KairseqOptimizer):
    """
    ...
    def __init__(self, cfg: KairseqBMUFConfig, optimizer):
        super().__init__(cfg)
    ...
    def add_args(parser):
        ...
        gen_parser_from_dataclass(parser, KairseqBMUFConfig())
