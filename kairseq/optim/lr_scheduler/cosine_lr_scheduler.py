...
from kairseq.optim.lr_scheduler import KairseqLRScheduler, register_lr_scheduler


@dataclass
class CosineLRScheduleConfig(KairseqDataclass):
...
class CosineLRSchedule(KairseqLRScheduler):
    ...
    def __init__(self, cfg: CosineLRScheduleConfig, kairseq_optimizer):
        super().__init__(cfg, kairseq_optimizer)
