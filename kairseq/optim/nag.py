...
from . import KairseqOptimizer, register_optimizer


@dataclass
class KairseqNAGConfig(KairseqDataclass):
...
@register_optimizer("nag", dataclass=KairseqNAGConfig)
class KairseqNAG(KairseqOptimizer):
