...
from kairseq.optim import KairseqOptimizer, register_optimizer
from kairseq.optim.fused_adam import get_fused_adam_class
...
@dataclass
class KairseqAdamConfig(KairseqDataclass):
    ...
    use_old_adam: bool = field(
        default=False, metadata={"help": "Use kairseq.optim.adam.Adam"}
    )
...
@register_optimizer("adam", dataclass=KairseqAdamConfig)
class KairseqAdam(KairseqOptimizer):
    """Adam optimizer for kairseq.
    ...
    def __init__(self, cfg: KairseqAdamConfig, params):
        super().__init__(cfg)
