...
class _FP16OptimizerMixin(object):
    ...
    def backward(self, loss):
        ...
        Compared to :func:`kairseq.optim.KairseqOptimizer.backward`, this
...
class FP16Optimizer(_FP16OptimizerMixin, optim.KairseqOptimizer):
    """
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            cfg (omegaconf.DictConfig): kairseq args
...
class MemoryEfficientFP16Optimizer(
    _MemoryEfficientFP16OptimizerMixin, optim.KairseqOptimizer
):
    """
    Wrap an *optimizer* to support FP16 (mixed precision) training.

    Compared to :class:`kairseq.optim.FP16Optimizer`, this version does not
    ...
    *supports_memory_efficient_fp16* property.
    ...
    def build_optimizer(cls, cfg: DictConfig, params, **kwargs):
        """
        Args:
            args (argparse.Namespace): kairseq args
            params (iterable): iterable of parameters to optimize
        """
