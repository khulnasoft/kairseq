...
from kairseq.optim import KairseqOptimizer, register_optimizer, _build_optimizer
from kairseq.optim.lr_scheduler import KairseqLRScheduler, build_lr_scheduler
...
@dataclass
class OptimizerAndSchedulerConfig(KairseqDataclass):
    optimizer: Any = None
...
@dataclass
class CompositeOptimizerConfig(KairseqDataclass):
...
class KairseqCompositeOptimizer(KairseqOptimizer):

    optimizers: Dict[str, KairseqOptimizer] = {}
    lr_schedulers: Dict[str, KairseqLRScheduler] = {}
    lr_scheduler: KairseqLRScheduler = None
...
class CompositeOptimizer(torch.optim.Optimizer):
    def __init__(self, optimizers: Dict[str, KairseqOptimizer]):
...
class CompositeLRScheduler(KairseqLRScheduler):
