...
from kairseq.dataclass.constants import (
...
@dataclass
class KairseqDataclass:
    """kairseq base dataclass that supported fetching attributes and metas"""
...
@dataclass
class CommonConfig(KairseqDataclass):
...
@dataclass
class DistributedTrainingConfig(KairseqDataclass):
...
@dataclass
class DatasetConfig(KairseqDataclass):
...
@dataclass
class OptimizationConfig(KairseqDataclass):
    max_epoch: int = field(
...
@dataclass
class CheckpointConfig(KairseqDataclass):
    save_dir: str = field(
...
@dataclass
class KairseqBMUFConfig(KairseqDataclass):
...
@dataclass
class GenerationConfig(KairseqDataclass):
    beam: int = field(
        default=5,
    ...
    # temporarily set to Any until https://github.com/khulnasoft/hydra/issues/1117 is fixed
...
@dataclass
class CommonEvalConfig(KairseqDataclass):
    ...
    post_process: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                "Valid options can be found in kairseq.data.utils.post_process."
            ),
...
@dataclass
class EvalLMConfig(KairseqDataclass):
...
@dataclass
class EMAConfig(KairseqDataclass):
...
@dataclass
class KairseqConfig(KairseqDataclass):
    ...
    bmuf: KairseqBMUFConfig = KairseqBMUFConfig()
