...
from kairseq.dataclass.configs import DistributedTrainingConfig, KairseqConfig
...
def distributed_init(cfg: KairseqConfig):
    ...
    if cfg.common.model_parallel_size > 1:
        try:
            from kairseq.model_parallel.megatron.mpu import (
            ...
            raise ImportError(
                ...
                "kairseq/model_parallel/megatron"
            )
...
def distributed_main(i, main, cfg: KairseqConfig, kwargs):
...
def call_main(cfg: KairseqConfig, main, **kwargs):
...
def get_data_parallel_group():
    ...
    global _USE_MEGATRON
    if _USE_MEGATRON:
        from kairseq.model_parallel.megatron import mpu
