...
from kairseq import search, utils
from kairseq.data import data_utils
from kairseq.models import KairseqIncrementalDecoder
from kairseq.ngram_repeat_block import NGramRepeatBlock
...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        Args:
            models (List[~kairseq.models.KairseqModel]): ensemble of models,
                currently support kairseq.models.TransformerModel for scripting
    ...
    def generate(
        ...
        """Generate translations. Match the api of other kairseq generators.
...
class EnsembleModel(nn.Module):
    ...
    def __init__(self, models):
        ...
        if all(
            hasattr(m, "decoder") and isinstance(m.decoder, KairseqIncrementalDecoder)
            for m in models
        ):
