...
from kairseq.incremental_decoding_utils import (
    KairseqIncrementalState,
...
def DynamicConv(
    ...
    if torch.cuda.is_available():
        try:
            from kairseq.modules.dynamicconv_layer import DynamicconvLayer
...
class DynamicConv1dTBC(nn.Module):
    ...
    def __init__(
        ...
        self.weight_dropout_module = KairseqDropout(
...
class DynamicConv_scripatable(nn.Module, KairseqIncrementalState):
    """Dynamic lightweight convolution taking T x B x C inputs
    Args:
        input_size: # of channels of the input
        kernel_size: convolution channels
