...
from kairseq.data.audio.data_cfg import MultitaskConfig, S2SDataConfig
from kairseq.data.audio.speech_to_speech_dataset import SpeechToSpeechDatasetCreator
from kairseq.data.audio.speech_to_text_dataset import (
    SpeechToTextDataset,
    TextTargetMultitaskData,
)
from kairseq.tasks import LegacyKairseqTask, register_task
from kairseq.tasks.speech_to_text import DummyMultiTask
from kairseq.tasks.text_to_speech import batch_mel_cepstral_distortion
...
class SpeechToSpeechTask(LegacyKairseqTask):
    @classmethod
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        if len(self.multitask_tasks) > 0:
            from kairseq.models.speech_to_speech.s2s_transformer import (
    ...
    def build_generator(
        ...
        if not self.args.target_is_code or self.args.eval_inference:
            from kairseq.models.text_to_speech.vocoder import get_vocoder
        ...
        if self.args.target_is_code:
            ...
            if has_dual_decoder:
                if getattr(args, "teacher_forcing", False):
                    ...
                    from kairseq.speech_generator import MultiDecoderSpeechGenerator
                ...
                if getattr(args, "teacher_forcing", False):
                    from kairseq.speech_generator import (
                    ...
                    from kairseq.speech_generator import AutoRegressiveSpeechGenerator
