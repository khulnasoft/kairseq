...
from kairseq.data import Dictionary, encoders
from kairseq.data.audio.audio_utils import get_features_or_waveform
from kairseq.data.audio.data_cfg import MultitaskConfig
...
class SpeechToTextTask(LegacyKairseqTask):
    @classmethod
...
class DummyMultiTask(LegacyKairseqTask):
