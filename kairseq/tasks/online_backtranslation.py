...
from kairseq.sequence_generator import SequenceGenerator
from kairseq.tasks import register_task
from kairseq.tasks.translation import TranslationTask, load_langpair_dataset
...
class OnlineBackTranslationTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--eval-bleu-detok', type=str, default="space",
                            help='detokenize before computing BLEU (e.g., "moses"); '
                                 ...
                                 'disable detokenization; see kairseq.data.encoders '
                                 'for other options')
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs) -> KairseqDataset:
    ...
    def load_train_dataset(self, data_path: str) -> KairseqDataset:
    ...
    def _langpair_dataset(
        self, src: KairseqDataset, tgt: KairseqDataset
    ) -> LanguagePairDataset:
    ...
    def load_bt_dataset(self, data_path: str, lang: str) -> KairseqDataset:
    ...
    def load_denoise_dataset(self, data_path: str, lang: str) -> KairseqDataset:
    ...
    def train_step(
        ...
        for dataset_key in dataset_keys:
            ...
            # Like in KairseqTask.train_step
...
def add_secial_tokens_to_dict_and_model(
    dictionary: "kairseq.data.Dictionary",
    model: nn.Module,
