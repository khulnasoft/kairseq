...
from kairseq.data.codedataset import ExpressiveCodeDataConfig, CodeDataset
from kairseq.dataclass.configs import KairseqDataclass
from kairseq.tasks import register_task
from kairseq.tasks.kairseq_task import KairseqTask
...
@dataclass
class SpeechUnitModelingConfig(KairseqDataclass):
...
class SpeechUnitLanguageModelingTask(KairseqTask):
    ...
    def build_criterion(self, cfg: DictConfig):
        ...
        return kairseq.criterions.build_criterion(cfg, self)
