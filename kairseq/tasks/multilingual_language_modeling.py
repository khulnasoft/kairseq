...
from kairseq.data.shorten_dataset import maybe_shorten_dataset
...
@dataclass
class MultilingualLanguageModelingConfig(KairseqDataclass):
...
class MultilingualLanguageModelingTask(LegacyKairseqTask):
    """
    Train a language model.

    Args:
        dictionary (~kairseq.data.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~kairseq.data.Dictionary): the dictionary for the
    ...
    .. note::
        ...
        The language modeling task is compatible with :mod:`kairseq-train`,
        :mod:`kairseq-generate`, :mod:`kairseq-interactive` and
        :mod:`kairseq-eval-lm`.
    ...
    .. argparse::
        :ref: kairseq.tasks.language_modeling_parser
        :prog:
    """
    ...
    def source_dictionary(self):
        """Return the :class:`~kairseq.data.Dictionary` for the language
        model."""
