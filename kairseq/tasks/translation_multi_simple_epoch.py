...
from kairseq.data.multilingual.multilingual_data_manager import (
    MultilingualDatasetManager,
)
from kairseq.data.multilingual.sampling_method import SamplingMethod
from kairseq.tasks import LegacyKairseqTask, register_task
from kairseq.utils import FileContentsAction
...
class TranslationMultiSimpleEpochTask(LegacyKairseqTask):
    """
    Translate from one (source) language to another (target) language.

    Args:
        langs (List[str]): a list of languages that are being supported
        dicts (Dict[str, kairseq.data.Dictionary]): mapping from supported languages to their dictionaries
    ...
    .. argparse::
        :ref: kairseq.tasks.translation_parser
        :prog:
    """
