...
import logging
import os
from kairseq.data.multi_corpus_dataset import MultiCorpusDataset
import torch
import json
...
from kairseq.data import AddTargetDataset, Dictionary, encoders
from kairseq.tasks.audio_pretraining import AudioPretrainingTask, AudioPretrainingConfig
from kairseq.dataclass import KairseqDataclass
from kairseq.dataclass.configs import GenerationConfig
from kairseq.data.text_compressor import TextCompressor, TextCompressionLevel
...
class AudioFinetuningConfig(AudioPretrainingConfig):
    ...
    eval_bleu_detok: Optional[str] = field(
        ...
        metadata={
            ...
            "detokenization; see kairseq.data.encoders for other options"
        },
    )
...
class AudioFinetuningTask(AudioPretrainingTask):
    ...
    def build_model(self, model_cfg: KairseqDataclass, from_checkpoint=False):
