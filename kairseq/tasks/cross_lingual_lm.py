...
import numpy as np
from kairseq import tokenizer, utils
from kairseq.data import ConcatDataset, Dictionary, TokenBlockDataset, data_utils
from kairseq.data.legacy.masked_lm_dataset import MaskedLMDataset
from kairseq.data.legacy.masked_lm_dictionary import MaskedLMDictionary
from kairseq.data.multi_corpus_sampled_dataset import MultiCorpusSampledDataset
...
class CrossLingualLMTask(LegacyKairseqTask):
    """
