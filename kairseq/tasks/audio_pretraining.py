...
from kairseq.data import BinarizedAudioDataset, FileAudioDataset, SubsampleDataset
from kairseq.dataclass import KairseqDataclass, ChoiceEnum
from kairseq.data.text_compressor import TextCompressionLevel

from . import KairseqTask, register_task
...
@dataclass
class AudioPretrainingConfig(KairseqDataclass):
...
class AudioPretrainingTask(KairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: KairseqDataclass = None, **kwargs):
