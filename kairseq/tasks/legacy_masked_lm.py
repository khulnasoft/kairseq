...
from kairseq.data import ConcatDataset, Dictionary, data_utils, indexed_dataset
from kairseq.data.legacy.block_pair_dataset import BlockPairDataset
from kairseq.data.legacy.masked_lm_dataset import MaskedLMDataset
from kairseq.data.legacy.masked_lm_dictionary import BertDictionary
...
class LegacyMaskedLMTask(LegacyKairseqTask):
    """
