...
from kairseq.tasks import KairseqDataclass, KairseqTask, register_task
...
@dataclass
class SentencePredictionConfig(KairseqDataclass):
...
class SentencePredictionTask(KairseqTask):
    """
