...
@dataclass
class SpeechDLMConfig(KairseqDataclass):
...
class SpeechDLMTask(LegacyKairseqTask):
    ...
    Args:
        dictionaries (Dict[str, ~kairseq.data.Dictionary]): the dictionaries for
            each input channel of the SpeechDLM model
        output_dictionaries (Dict[str, ~kairseq.data.Dictionary]): the dictionaries
    ...
    .. note::
        ...
        :mod:`kairseq-train` and :mod:`kairseq-validate`.
    ...
    def source_dictionaries(self):
        """Return the dict of :class:`~kairseq.data.Dictionary` for the
    ...
    def build_generator(self, models, args, extra_gen_cls_kwargs=None):
        ...
        from kairseq.models.speech_dlm.sequence_generator import (
            multichannel_search,
