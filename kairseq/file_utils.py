...
default_cache_path = os.path.join(torch_cache_home, "pytorch_kairseq")
...
try:
    ...
    PYTORCH_KAIRSEQ_CACHE = Path(os.getenv("PYTORCH_KAIRSEQ_CACHE", default_cache_path))
except (AttributeError, ImportError):
    PYTORCH_KAIRSEQ_CACHE = os.getenv("PYTORCH_KAIRSEQ_CACHE", default_cache_path)
...
def filename_to_url(filename, cache_dir=None):
    ...
    if cache_dir is None:
        cache_dir = PYTORCH_KAIRSEQ_CACHE
