...
from kairseq.models import KairseqEncoderDecoderModel
...
class TransformerModelBase(KairseqEncoderDecoderModel):
    """
    ...
    .. argparse::
        :ref: kairseq.models.transformer_parser
        :prog:
    """
    ...
    # Since get_normalized_probs is in the Kairseq Model which is not scriptable,
