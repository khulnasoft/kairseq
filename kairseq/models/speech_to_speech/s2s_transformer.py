...
from kairseq.models.speech_to_text import S2TTransformerEncoder
from kairseq.models.text_to_speech import TTSTransformerDecoder
from kairseq.models.transformer import Linear, TransformerDecoder, TransformerModelBase
...
class S2STransformerMultitaskModelBase(KairseqEncoderDecoderModel):
    @classmethod
