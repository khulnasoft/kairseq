...
from kairseq.models.speech_to_text import S2TConformerEncoder
from kairseq.models.transformer import Linear
...
class S2UTConformerModel(S2UTTransformerModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            metavar="STR",
            help="If not specified uses kairseq MHA. Other valid option is espnet for using conformer",
        )
        parser.add_argument(
            "--pos-enc-type",
            type=str,
