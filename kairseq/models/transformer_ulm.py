...
from kairseq.models.kairseq_decoder import KairseqDecoder
import numpy as np
...
from kairseq.tasks.speech_ulm_task import SpeechUnitLanguageModelingTask
from kairseq.models.transformer import Embedding, TransformerDecoder, Linear
from kairseq.models.transformer_lm import TransformerLanguageModelConfig
...
class TransformerUnitLanguageModel(KairseqLanguageModel):
    def __init__(
        self,
        cfg: SpeechUnitLanguageModelConfig,
        task: SpeechUnitLanguageModelingTask,
        decoder: KairseqDecoder,
    ):
