...
inside the model, please use kairseq/modules/ema_module.py instead.
"""
...
class EMA(object):
    """Exponential Moving Average of Kairseq Models
    ...
    the open source code in https://github.com/zhawe01/kairseq-gec.git,
