...
import kairseq.checkpoint_utils
from kairseq.models import (
    KairseqEncoderDecoderModel,
    register_model,
    register_model_architecture,
)
from kairseq.models.transformer import TransformerDecoder
from kairseq.models.roberta import model as roberta

logger = logging.getLogger(__name__)


@register_model("roberta_enc_dec")
class RobertaEncDecModel(KairseqEncoderDecoderModel):
    @staticmethod
    def add_args(parser):
        parser.add_argument(
    ...
    def build_model(cls, args, task):
        ...
        if args.pretrained_mlm_checkpoint:
            ...
            loaded = kairseq.checkpoint_utils.load_model_ensemble_and_task(
