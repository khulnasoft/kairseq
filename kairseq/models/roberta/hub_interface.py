...
class RobertaHubInterface(nn.Module):
    ...
    Usage: https://github.com/pytorch/kairseq/tree/main/examples/roberta
    """
    ...
    def extract_features_aligned_to_words(
        ...
        from kairseq.models.roberta import alignment_utils
    ...
    def fill_mask(self, masked_input: str, topk: int = 5):
        ...
        for index, predicted_token_bpe in enumerate(
            ...
            # Quick hack to fix https://github.com/pytorch/kairseq/issues/1306
