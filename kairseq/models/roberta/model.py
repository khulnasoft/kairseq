...
from kairseq.models.transformer import DEFAULT_MIN_PARAMS_TO_WRAP, TransformerEncoder
from kairseq.modules import LayerNorm
from kairseq.modules.quant_noise import quant_noise as apply_quant_noise_
...
class RobertaModel(KairseqEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
            "roberta.base": "http://dl.fbaipublicfiles.com/kairseq/models/roberta.base.tar.gz",
            "roberta.large": "http://dl.fbaipublicfiles.com/kairseq/models/roberta.large.tar.gz",
            "roberta.large.mnli": "http://dl.fbaipublicfiles.com/kairseq/models/roberta.large.mnli.tar.gz",
            "roberta.large.wsc": "http://dl.fbaipublicfiles.com/kairseq/models/roberta.large.wsc.tar.gz",
        }
...
class RobertaEncoder(KairseqEncoder):
    """RoBERTa encoder."""
