...
from kairseq import options, utils
from kairseq.dataclass import ChoiceEnum, KairseqDataclass
from kairseq.models import (
    KairseqLanguageModel,
    register_model,
    register_model_architecture,
)
from kairseq.models.transformer import (
    DEFAULT_MIN_PARAMS_TO_WRAP,
    Embedding,
    TransformerDecoder,
)
from kairseq.modules import AdaptiveInput, CharacterTokenEmbedder
from kairseq.utils import safe_getattr, safe_hasattr
...
class TransformerLanguageModel(KairseqLanguageModel):
    ...
    def hub_models(cls):
        ...
        return {
            "transformer_lm.gbw.adaptive_huge": "https://dl.fbaipublicfiles.com/kairseq/models/lm/adaptive_lm_gbw_huge.tar.bz2",
            "transformer_lm.wiki103.adaptive": "https://dl.fbaipublicfiles.com/kairseq/models/lm/adaptive_lm_wiki103.v2.tar.bz2",
            "transformer_lm.wmt19.en": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt19.en.tar.bz2"
            ),
            "transformer_lm.wmt19.de": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt19.de.tar.bz2"
            ),
            "transformer_lm.wmt19.ru": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt19.ru.tar.bz2"
            ),
            "transformer_lm.wmt20.en": spm(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt20.en.tar.gz"
            ),
            "transformer_lm.wmt20.ta": spm(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt20.ta.tar.gz"
            ),
            "transformer_lm.wmt20.iu.news": spm(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt20.iu.news.tar.gz"
            ),
            "transformer_lm.wmt20.iu.nh": spm(
                "https://dl.fbaipublicfiles.com/kairseq/models/lm/wmt20.iu.nh.tar.gz"
            ),
        }
