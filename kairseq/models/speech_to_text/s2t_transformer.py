...
from kairseq.models.transformer import Embedding, TransformerDecoder
...
class S2TTransformerModel(KairseqEncoderDecoderModel):
...
class S2TTransformerEncoder(KairseqEncoder):
