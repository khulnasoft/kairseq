...
from kairseq import checkpoint_utils, utils
from kairseq.data.data_utils import lengths_to_padding_mask
...
from kairseq.models.speech_to_speech.modules.ctc_decoder import CTCDecoder
from kairseq.models.speech_to_text.hub_interface import S2THubInterface
from kairseq.models.transformer import (
    Embedding,
    TransformerDecoder,
    TransformerModelBase,
)
from kairseq.models.wav2vec import Wav2VecEncoder
from kairseq.modules.layer_norm import LayerNorm
...
class Wav2VecEncoderWithAdaptor(KairseqEncoder):
...
class XMTransformerModel(KairseqEncoderDecoderModel):
    @classmethod
    def hub_models(cls):
        base_url = "http://dl.fbaipublicfiles.com/kairseq/s2t"
        model_ids = [
    ...
    def build_multitask_decoder(
        ...
        if mtl_args.decoder_type == "transformer":
            if is_first_pass_decoder:
                ...
                from kairseq.models.speech_to_speech import (
