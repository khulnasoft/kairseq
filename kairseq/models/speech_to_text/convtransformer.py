...
from kairseq.models.speech_to_text.modules.convolution import infer_conv_output_dim
from kairseq.models.transformer import Embedding, TransformerDecoder
from kairseq.modules import LayerNorm, PositionalEmbedding, TransformerEncoderLayer

logger = logging.getLogger(__name__)


@register_model("convtransformer")
class ConvTransformerModel(KairseqEncoderDecoderModel):
    """
...
class ConvTransformerEncoder(KairseqEncoder):
