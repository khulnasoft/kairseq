...
from kairseq.models import KairseqEncoder, register_model, register_model_architecture
from kairseq.models.speech_to_text.modules.convolution import (
    Conv1dSubsampler,
    Conv2dSubsampler,
)
from kairseq.models.speech_to_text.s2t_transformer import (
...
from kairseq.modules import PositionalEmbedding, RelPositionalEncoding
from kairseq.modules.conformer_layer import ConformerEncoderLayer

logger = logging.getLogger(__name__)


class S2TConformerEncoder(KairseqEncoder):
    ...
    def reorder_encoder_out(self, encoder_out, new_order):
        """Required method for a KairseqEncoder. Calls the method from the parent class"""
...
class S2TConformerModel(S2TTransformerModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=str,
            metavar="STR",
            help="If not specified uses kairseq MHA. Other valid option is espnet",
        )
        parser.add_argument(
            "--pos-enc-type",
            type=str,
