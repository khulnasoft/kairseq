...
from kairseq.models.speech_to_text import ConvTransformerEncoder
from kairseq.models.speech_to_text.utils import (
    attention_suppression,
    lengths_to_encoder_padding_mask,
    segments_to_sequence,
    sequence_to_segments,
)
from kairseq.modules import MultiheadAttention, TransformerEncoderLayer
...
#   SequenceEncoder
# ------------------------------------------------------------------------------
class SequenceEncoder(KairseqEncoder):
    """
