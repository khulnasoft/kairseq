...
from kairseq.models.wav2vec import ConvFeatureExtractionModel
from kairseq.modules import GradMultiply, LayerNorm, SamePad, TransformerEncoderLayer
...
class SpeechWavTransformerEncoder(KairseqEncoder):
...
class StackedSpeechWavTransformerEncoder(KairseqEncoder):
