...
from kairseq.utils import buffered_arange
...
@dataclass
class Wav2VecConfig(KairseqDataclass):
...
class Wav2VecModel(BaseKairseqModel):
    @classmethod
    def build_model(cls, cfg: Wav2VecConfig, task: KairseqTask):
