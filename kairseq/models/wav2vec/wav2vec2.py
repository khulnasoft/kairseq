...
from kairseq.data.data_utils import compute_mask_indices
...
from kairseq.distributed.fully_sharded_data_parallel import FullyShardedDataParallel
...
from kairseq.modules.conformer_layer import ConformerWav2Vec2EncoderLayer
from kairseq.modules.transformer_sentence_encoder import init_bert_params
from kairseq.utils import buffered_arange, index_put, is_xla_tensor
...
@dataclass
class Wav2Vec2Config(KairseqDataclass):
...
class Wav2Vec2Model(BaseKairseqModel):
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        """Upgrade a (possibly old) state dict for new versions of kairseq."""
        return state_dict
