...
from kairseq.models import BaseKairseqModel, KairseqEncoder, register_model
from kairseq.models.wav2vec.wav2vec2 import MASKING_DISTRIBUTION_CHOICES, Wav2Vec2Config
from kairseq.models.wav2vec.wav2vec2_asr import Embedding, Linear, Wav2VecEncoder, Wav2Vec2AsrConfig
...
class Wav2VecClassification(BaseKairseqModel):
    ...
    @classmethod
    def build_model(cls, cfg: Wav2Vec2ClassificationConfig, task: KairseqTask):
