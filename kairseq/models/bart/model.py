...
from kairseq.models import register_model, register_model_architecture
...
class BARTModel(TransformerModel):
    ...
    def hub_models(cls):
        return {
            "bart.base": "http://dl.fbaipublicfiles.com/kairseq/models/bart.base.tar.gz",
            "bart.large": "http://dl.fbaipublicfiles.com/kairseq/models/bart.large.tar.gz",
            "bart.large.mnli": "http://dl.fbaipublicfiles.com/kairseq/models/bart.large.mnli.tar.gz",
            "bart.large.cnn": "http://dl.fbaipublicfiles.com/kairseq/models/bart.large.cnn.tar.gz",
            "bart.large.xsum": "http://dl.fbaipublicfiles.com/kairseq/models/bart.large.xsum.tar.gz",
        }
