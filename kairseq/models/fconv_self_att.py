...
from kairseq.incremental_decoding_utils import with_incremental_state
...
class FConvModelSelfAtt(KairseqEncoderDecoderModel):
    @classmethod
    def hub_models(cls):
        return {
            "conv.stories.pretrained": {
                "path": "https://dl.fbaipublicfiles.com/kairseq/models/stories_checkpoint.tar.gz",
            ...
            "data.stories": "https://dl.fbaipublicfiles.com/kairseq/data/stories_test.tar.bz2",
        }
...
class FConvDecoder(KairseqDecoder):
