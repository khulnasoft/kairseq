...
class FConvModel(KairseqEncoderDecoderModel):
    """
    ...
    .. argparse::
        :ref: kairseq.models.fconv_parser
        :prog:
    """
    ...
    def hub_models(cls):
        ...
        return {
            "conv.wmt14.en-fr": moses_subword(
                "https://dl.fbaipublicfiles.com/kairseq/models/wmt14.v2.en-fr.fconv-py.tar.bz2"
            ),
            "conv.wmt14.en-de": moses_subword(
                "https://dl.fbaipublicfiles.com/kairseq/models/wmt14.en-de.fconv-py.tar.bz2"
            ),
            "conv.wmt17.en-de": moses_subword(
                "https://dl.fbaipublicfiles.com/kairseq/models/wmt17.v2.en-de.fconv-py.tar.bz2"
            ),
        }
...
class FConvEncoder(KairseqEncoder):
    """
...
class FConvDecoder(KairseqIncrementalDecoder):
...
def ConvTBC(in_channels, out_channels, kernel_size, dropout=0.0, **kwargs):
    ...
    from kairseq.modules import ConvTBC
