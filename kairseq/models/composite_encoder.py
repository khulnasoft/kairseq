...
class CompositeEncoder(KairseqEncoder):
    """
    A wrapper around a dictionary of :class:`KairseqEncoder` objects.
    ...
    Args:
        encoders (dict): a dictionary of :class:`KairseqEncoder` objects.
    """
