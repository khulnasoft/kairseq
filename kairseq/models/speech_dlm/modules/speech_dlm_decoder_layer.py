...
from kairseq.modules import LayerNorm, MultiheadAttention
from kairseq.modules.kairseq_dropout import KairseqDropout
from kairseq.modules.quant_noise import quant_noise
...
class CrossChannelTransformerDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.activation_dropout_module = KairseqDropout(
...
# Rewrite kairseq.modules.TransformerDecoderLayer
...
class StandardTransformerDecoderLayer(nn.Module):
    """Rewrite kairseq.modules.TransformerDecoderLayer to avoid forwarding
