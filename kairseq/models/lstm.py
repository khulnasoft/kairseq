...
from kairseq.modules import AdaptiveSoftmax, KairseqDropout
...
@register_model("lstm")
class LSTMModel(KairseqEncoderDecoderModel):
...
class LSTMEncoder(KairseqEncoder):
    """LSTM encoder."""
    ...
    def __init__(
        ...
        self.dropout_in_module = KairseqDropout(
            dropout_in * 1.0, module_name=self.__class__.__name__
        )
        self.dropout_out_module = KairseqDropout(
...
class LSTMDecoder(KairseqIncrementalDecoder):
    """LSTM decoder."""
