...
from kairseq.iterative_refinement_generator import DecoderOut
from kairseq.models import register_model, register_model_architecture
from kairseq.models.nat import KairseqNATDecoder, KairseqNATModel, ensemble_decoder
from kairseq.models.transformer import Embedding
from kairseq.modules import TransformerDecoderLayer
...
class LevenshteinTransformerModel(KairseqNATModel):
    @property
    ...
    @staticmethod
    def add_args(parser):
        KairseqNATModel.add_args(parser)
        parser.add_argument(
            "--early-exit",
            default="6,6,6",
            type=str,
...
class LevenshteinTransformerDecoder(KairseqNATDecoder):
