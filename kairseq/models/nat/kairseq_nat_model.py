...
class KairseqNATModel(TransformerModel):
    """
    ...
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        decoder = KairseqNATDecoder(args, tgt_dict, embed_tokens)
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        encoder = KairseqNATEncoder(args, src_dict, embed_tokens)
        if getattr(args, "apply_bert_init", False):
...
class KairseqNATEncoder(TransformerEncoder):
...
class KairseqNATDecoder(TransformerDecoder):
