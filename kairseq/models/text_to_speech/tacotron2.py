...
from kairseq.modules import LSTMCellWithZoneOut, LocationAttention
...
class Tacotron2Encoder(KairseqEncoder):
...
class Tacotron2Decoder(KairseqIncrementalDecoder):
...
class Tacotron2Model(KairseqEncoderDecoderModel):
    """
