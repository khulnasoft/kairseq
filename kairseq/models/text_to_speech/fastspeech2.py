...
from kairseq.models.text_to_speech.tacotron2 import Postnet
...
class PositionwiseFeedForward(nn.Module):
    def __init__(self, in_dim, hidden_dim, kernel_size, dropout):
        ...
        self.dropout = self.dropout_module = KairseqDropout(
...
class FastSpeech2Encoder(KairseqEncoder):
...
class FastSpeech2Model(KairseqEncoderModel):
    """
