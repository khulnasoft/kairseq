...
from kairseq.models.text_to_speech.hub_interface import TTSHubInterface
from kairseq.models.text_to_speech.tacotron2 import Postnet, Prenet
...
class TTSTransformerEncoder(KairseqEncoder):
...
class TTSTransformerDecoder(KairseqIncrementalDecoder):
...
class TTSTransformerModel(KairseqEncoderDecoderModel):
    """
    ...
    @classmethod
    def hub_models(cls):
        base_url = "http://dl.fbaipublicfiles.com/kairseq/s2"
        model_ids = [
