...
from kairseq.data.audio.audio_utils import (
    TTSSpectrogram,
    get_fourier_basis,
    get_mel_filters,
    get_window,
)
from kairseq.data.audio.speech_to_text_dataset import S2TDataConfig
from kairseq.models import BaseKairseqModel, register_model
from kairseq.models.text_to_speech.codehifigan import CodeGenerator as CodeHiFiGANModel
from kairseq.models.text_to_speech.hifigan import Generator as HiFiGANModel
from kairseq.models.text_to_speech.hub_interface import VocoderHubInterface
...
class CodeHiFiGANVocoder(BaseKairseqModel):
    def __init__(
        self, checkpoint_path: str, model_cfg: Dict[str, str], fp16: bool = False
    ) -> None:
        super().__init__()
    ...
    @classmethod
    def hub_models(cls):
        base_url = "http://dl.fbaipublicfiles.com/kairseq/vocoder"
        model_ids = [
