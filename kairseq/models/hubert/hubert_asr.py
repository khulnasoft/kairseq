...
from kairseq.models.hubert.hubert import MASKING_DISTRIBUTION_CHOICES
...
@dataclass
class HubertAsrConfig(KairseqDataclass):
...
class HubertCtc(BaseKairseqModel):
    def __init__(self, cfg: HubertCtcConfig, w2v_encoder: BaseKairseqModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: HubertCtcConfig, task: KairseqTask):
...
class HubertSeq2SeqModel(KairseqEncoderDecoderModel):
    def __init__(self, encoder, decoder):
        super().__init__(encoder, decoder)

    @classmethod
    def build_model(cls, cfg: HubertSeq2SeqConfig, task: KairseqTask):
        """Build a new model instance."""
...
class HubertEncoder(KairseqEncoder):
