...
from kairseq.models.xmod.transformer_layer_xmod import XMODTransformerEncoderLayerBase
from ..roberta.model import base_architecture, RobertaEncoder
from kairseq.models.transformer import TransformerEncoder
from kairseq.modules.transformer_sentence_encoder import init_bert_params
from typing import Optional
from kairseq.models.xmod.hub_interface import XMODHubInterface
import torch
from kairseq.distributed import fsdp_wrap
from kairseq.models import (
    register_model,
    register_model_architecture,
)

from kairseq.modules.checkpoint_activations import checkpoint_wrapper
...
class XMODModel(XLMRModel):
    ...
    def hub_models(cls):
        return {
            "xmod.base": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.81.1M.tar.gz",
            "xmod.large.prenorm": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.large.prenorm.81.500k.tar.gz",
            "xmod.base.13.125k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.13.125k.tar.gz",
            "xmod.base.30.125k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.30.125k.tar.gz",
            "xmod.base.30.195k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.30.195k.tar.gz",
            "xmod.base.60.125k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.60.125k.tar.gz",
            "xmod.base.60.265k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.60.265k.tar.gz",
            "xmod.base.75.125k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.75.125k.tar.gz",
            "xmod.base.75.269k": "https://dl.fbaipublicfiles.com/kairseq/models/xmod/xmod.base.75.269k.tar.gz",
        }
