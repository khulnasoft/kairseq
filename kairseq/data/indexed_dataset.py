...
import numpy as np
import torch
from kairseq.dataclass.constants import DATASET_IMPL_CHOICES
from kairseq.data.fasta_dataset import FastaDataset
from kairseq.file_io import PathManager
from kairseq.data.huffman import HuffmanMMapIndexedDataset, HuffmanMMapIndex

from . import KairseqDataset
...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        from kairseq.data.fasta_dataset import EncodedFastaDataset
...
class IndexedDataset(KairseqDataset):
...
class IndexedRawTextDataset(KairseqDataset):
...
class MMapIndexedDataset(torch.utils.data.Dataset):
    ...
    def can_reuse_epoch_itr_across_epochs(self):
        # TODO: a quick fix. make it a child class of KairseqDataset instead?
        return True
