...
def load_indexed_dataset(
    ...
    Args:
        ...
        dictionary (~kairseq.data.Dictionary): data dictionary
    ...
    """
    import kairseq.data.indexed_dataset as indexed_dataset
    from kairseq.data.concat_dataset import ConcatDataset
...
def filter_by_size(indices, dataset, max_positions, raise_exception=False):
    ...
    Use `KairseqDataset::filter_indices_by_size` instead.

    Args:
        indices (List[int]): ordered list of dataset indices
        dataset (KairseqDataset): kairseq dataset instance
...
def batch_by_size(
    ...
    """
    try:
        from kairseq.data.data_utils_fast import (
            batch_by_size_fn,
            batch_by_size_vec,
