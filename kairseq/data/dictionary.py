...
from kairseq.file_chunker_utils import Chunker, find_offsets
from kairseq.file_io import PathManager
from kairseq.tokenizer import tokenize_line
            ...
            try:
                ...
                if word in self and not overwrite:
                    raise RuntimeError(
                        ...
                        "#kairseq:overwrite flag at the end of the corresponding row "
