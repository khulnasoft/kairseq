...
from kairseq.data import KairseqDataset, MonolingualDataset, data_utils


class SpeechDLMDataset(KairseqDataset):
    ...
    being instances of :class:`~kairseq.data.MonolingualDataset`.
    ...
    Args:
        datasets (Dict[str, ~kairseq.data.MonolingualDataset]): a dictionary of
            :class:`~kairseq.data.MonolingualDataset` instances.
