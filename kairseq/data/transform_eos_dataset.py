...
class TransformEosDataset(KairseqDataset):
    """A :class:`~kairseq.data.KairseqDataset` wrapper that appends/prepends/strips EOS.

    Note that the transformation is applied in :func:`collater`.

    Args:
        dataset (~kairseq.data.KairseqDataset): dataset to wrap
    ...
    def __init__(
        ...
        if not isinstance(dataset, KairseqDataset):
            raise ValueError("dataset must be an instance of KairseqDataset")
