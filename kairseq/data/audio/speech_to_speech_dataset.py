...
from kairseq.data import ConcatDataset, Dictionary
...
from kairseq.data.audio.data_cfg import S2SDataConfig
...
class SpeechToSpeechDataset(SpeechToTextDataset):
    ...
    def pack_units(self, input: torch.Tensor) -> torch.Tensor:
        ...
        )  # remove offset from <bos>, <pad>, <eos>, <unk>, which is specific to kairseq dictionary
