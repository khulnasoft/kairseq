...
class TransformEosLangPairDataset(KairseqDataset):
    """A :class:`~kairseq.data.KairseqDataset` wrapper that transform bos on
    collated samples of language pair dataset.

    Note that the transformation is applied in :func:`collater`.

    Args:
        dataset (~kairseq.data.KairseqDataset): dataset that collates sample into
