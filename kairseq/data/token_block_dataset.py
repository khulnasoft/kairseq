...
import numpy as np
import torch
from kairseq.data import KairseqDataset, plasma_utils
from kairseq.data.indexed_dataset import best_fitting_int_dtype
from typing import Tuple


class TokenBlockDataset(KairseqDataset):
    ...
    def _build_slice_indices(
        ...
        try:
            from kairseq.data.token_block_utils_fast import (
