...
import numpy as np
import torch
from kairseq.data import Dictionary, KairseqDataset, data_utils
from kairseq.data.concat_dataset import ConcatDataset
from kairseq.data.legacy.block_pair_dataset import BlockPairDataset
from kairseq.data.token_block_dataset import TokenBlockDataset


class MaskedLMDataset(KairseqDataset):
    """
