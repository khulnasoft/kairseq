...
class MultiCorpusDataset(KairseqDataset):
    """
    Stores multiple instances of KairseqDataset together.
    ...
    Args:
        datasets: a OrderedDict of KairseqDataset instances.
    ...
    def __init__(
        self,
        datasets: Dict[str, KairseqDataset],
