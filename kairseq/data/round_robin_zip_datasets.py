...
from . import KairseqDataset, LanguagePairDataset

logger = logging.getLogger(__name__)


class RoundRobinZipDatasets(KairseqDataset):
    """Zip multiple :class:`~kairseq.data.KairseqDataset` instances together.

    Shorter datasets are repeated in a round-robin fashion to match the length
    of the longest one.

    Args:
        datasets (Dict[~kairseq.data.KairseqDataset]): a dictionary of
            :class:`~kairseq.data.KairseqDataset` instances.
