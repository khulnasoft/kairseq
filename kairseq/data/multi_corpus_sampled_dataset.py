...
class MultiCorpusSampledDataset(KairseqDataset):
    """
    Stores multiple instances of KairseqDataset together and in every iteration
    ...
    Args:
        datasets: an OrderedDict of KairseqDataset instances.
