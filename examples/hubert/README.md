...
HuBERT Large (~316M params) | [Libri-Light](https://github.com/khulnasoft/libri-light) 60k hr | No finetuning (Pretrained Model) | [download](https://dl.fbaipublicfiles.com/hubert/hubert_large_ll60k.pt)
HuBERT Extra Large (~1B params) | [Libri-Light](https://github.com/khulnasoft/libri-light) 60k hr |  No finetuning (Pretrained Model) | [download](https://dl.fbaipublicfiles.com/hubert/hubert_xtralarge_ll60k.pt)
HuBERT Large | [Libri-Light](https://github.com/khulnasoft/libri-light) 60k hr | [Librispeech](http://www.openslr.org/12) 960 hr | [download](https://dl.fbaipublicfiles.com/hubert/hubert_large_ll60k_finetune_ls960.pt)
HuBERT Extra Large | [Libri-Light](https://github.com/khulnasoft/libri-light) 60k hr | [Librispeech](http://www.openslr.org/12) 960 hr | [download](https://dl.fbaipublicfiles.com/hubert/hubert_xtralarge_ll60k_finetune_ls960.pt)

## Load a model
```
ckpt_path = "/path/to/the/checkpoint.pt"
models, cfg, task = kairseq.checkpoint_utils.load_model_ensemble_and_task([ckpt_path])
model = models[0]
```
...
```sh
$ python kairseq_cli/hydra_train.py \
  --config-dir /path/to/kairseq-py/examples/hubert/config/pretrain \
...
```sh
$ python kairseq_cli/hydra_train.py \
  --config-dir /path/to/kairseq-py/examples/hubert/config/finetune \
...
- Kairseq-LM deocding: decoding with a Kairseq neural language model
...
$ python examples/speech_recognition/new/infer.py \
  --config-dir /path/to/kairseq-py/examples/hubert/config/decode \
...
To decode with a Kairseq LM, use `--config-name infer_fsqlm` instead, and
