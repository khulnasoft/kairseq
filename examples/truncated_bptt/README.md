...
It is slightly tricky to implement Truncated BPTT efficiently in kairseq, since
...
BPTT in kairseq by overriding ``KairseqTask::get_batch_iterator`` to iterate
...
# ... | INFO | kairseq_cli.eval_lm | num. model params: 151123537
# ... | INFO | kairseq_cli.eval_lm | Evaluated 245569 tokens in 83.1s (2956.82 tokens/s)
# ... | INFO | kairseq_cli.eval_lm | Loss (base 2): 4.5668, Perplexity: 23.70
