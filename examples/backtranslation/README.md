...
---|---|---|---
`transformer.wmt18.en-de` | Transformer <br> ([Edunov et al., 2018](https://arxiv.org/abs/1808.09381)) <br> WMT'18 winner | [WMT'18 English-German](http://www.statmt.org/wmt18/translation-task.html) | [download (.tar.gz)](https://dl.fbaipublicfiles.com/kairseq/models/wmt18.en-de.ensemble.tar.gz) <br> See NOTE in the archive
...
torch.hub.list('pytorch/kairseq')  # [..., 'transformer.wmt18.en-de', ... ]

# Load the WMT'18 En-De ensemble
en2de_ensemble = torch.hub.load(
    'pytorch/kairseq', 'transformer.wmt18.en-de',
...
# and the BT data as "train1", so that kairseq will combine them automatically
