...
from kairseq.distributed.utils import get_data_parallel_world_size
...
@dataclass
class DecodingConfig(KairseqDataclass):
...
@dataclass
class UnpairedAudioTextConfig(KairseqDataclass):
    data: str = field(
...
class UnpairedAudioText(KairseqTask):
    """ """
