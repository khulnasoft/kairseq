...
```bash
mkdir -p gpt2_bpe
wget -O gpt2_bpe/encoder.json https://dl.fbaipublicfiles.com/kairseq/gpt2_bpe/encoder.json
wget -O gpt2_bpe/vocab.bpe https://dl.fbaipublicfiles.com/kairseq/gpt2_bpe/vocab.bpe
...
Finally preprocess/binarize the data using the GPT-2 kairseq dictionary:
```bash
wget -O gpt2_bpe/dict.txt https://dl.fbaipublicfiles.com/kairseq/gpt2_bpe/dict.txt
kairseq-preprocess \
    --only-source \
...
kairseq-hydra-train -m --config-dir examples/roberta/config/pretraining \
