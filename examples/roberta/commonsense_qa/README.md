...
KAIRSEQ_PATH=/path/to/kairseq
KAIRSEQ_USER_DIR=${KAIRSEQ_PATH}/examples/roberta/commonsense_qa

CUDA_VISIBLE_DEVICES=0 kairseq-train --fp16 --ddp-backend=legacy_ddp \
    $DATA_DIR \
    --user-dir $KAIRSEQ_USER_DIR \
...
for batched prediction with RoBERTa](https://github.com/pytorch/kairseq/tree/main/examples/roberta#batched-prediction).
