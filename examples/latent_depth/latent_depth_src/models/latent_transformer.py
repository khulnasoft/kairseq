...
from kairseq.models.transformer import TransformerDecoder, TransformerEncoder
from kairseq.modules import TransformerDecoderLayer, TransformerEncoderLayer
