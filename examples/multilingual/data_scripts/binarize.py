...
if not os.path.exists(SPM_MODEL):
    call(f"wget https://dl.fbaipublicfiles.com/kairseq/models/mbart50/sentence.bpe.model -O {SPM_MODEL}")


if not os.path.exists(SPM_VOCAB):
    call(f"wget https://dl.fbaipublicfiles.com/kairseq/models/mbart50/dict_250k.txt -O {SPM_VOCAB}")
