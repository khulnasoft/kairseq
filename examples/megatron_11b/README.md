...
---|---|---|---|---
`megatron_11b` | megatron_11b unidirectional language model | 11B | 19Gb | [megatron_11b.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/model_parallel/megatron_11b.tar.gz)
...
kairseq. We assume that each machine (node) has 8 GPUs among which to split the
...
wget https://dl.fbaipublicfiles.com/kairseq/models/model_parallel/megatron_11b.tar.gz
...
`kairseq-eval-lm` needs to be renormalized.
