...
from kairseq.models.multilingual_transformer import (
...
class MultilingualTransformerModelFromMbart(MultilingualTransformerModel):
    ...
    def build_model(cls, args, task):
        ...
        from kairseq.tasks.multilingual_translation import MultilingualTranslationTask
        ...
        if args.share_all_embeddings:
            ...
            shared_encoder_embed_tokens = KairseqMultiModel.build_shared_embeddings(
                dicts=task.dicts,
                langs=task.langs,
            ...
            if args.share_decoder_embeddings:
                shared_decoder_embed_tokens = KairseqMultiModel.build_shared_embeddings(
                    dicts=task.dicts,
                    langs=tgt_langs,
    ...
    def load_state_dict(self, state_dict, strict=True, model_cfg=None):
        ...
        if finetune_mode:
            ...
            # we need this code because mBART/BART are not of type KairseqMultiModel but KairseqModel
