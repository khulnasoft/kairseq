...
def main():
    ...
    parser.add_argument("--dict", default="/checkpoint/felixkreuk/datasets/emov/manifests/emov_16khz/kairseq.dict.txt", help="")
    ...
    # kairseq-preprocess the denoising data
    ...
    # kairseq-preprocess the translation data
