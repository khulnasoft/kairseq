...
def main():
    ...
    parser.add_argument("--dict", default="/checkpoint/felixkreuk/datasets/emov/manifests/emov_16khz/kairseq.dict.txt")
    ...
    logger.info("generating kairseq manifests")
    run_cmd(f"python preprocess/build_translation_manifests.py {outdir} {outdir}/kairseq-data -dd -cs --dict {args.dict}")
