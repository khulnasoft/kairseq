...
You can find more information about LASER and how to use it on the official [LASER repository](https://github.com/khulnasoft/LASER).
...
Binarize your data with kairseq, as described [here](https://kairseq.readthedocs.io/en/latest/getting_started.html#data-pre-processing).
...
```
where paths are paths to binarized indexed kairseq dataset files.
...
* [**Cross-lingual document classification**](https://github.com/khulnasoft/LASER/tree/master/tasks/mldoc) using the
  [*MLDoc*](https://github.com/khulnasoft/MLDoc) corpus [2,6]
* [**WikiMatrix**](https://github.com/khulnasoft/LASER/tree/master/tasks/WikiMatrix)
   Mining 135M Parallel Sentences in 1620 Language Pairs from Wikipedia [7]
* [**Bitext mining**](https://github.com/khulnasoft/LASER/tree/master/tasks/bucc) using the
  [*BUCC*](https://comparable.limsi.fr/bucc2018/bucc2018-task.html) corpus [3,5]
* [**Cross-lingual NLI**](https://github.com/khulnasoft/LASER/tree/master/tasks/xnli)
  using the [*XNLI*](https://www.nyu.edu/projects/bowman/xnli/) corpus [4,5,6]
* [**Multilingual similarity search**](https://github.com/khulnasoft/LASER/tree/master/tasks/similarity) [1,6]
* [**Sentence embedding of text files**](https://github.com/khulnasoft/LASER/tree/master/tasks/embed)
