...
---|---|---|---
`bart.base` | BART model with 6 encoder and decoder layers | 140M | [bart.base.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/bart.base.tar.gz)
`bart.large` | BART model with 12 encoder and decoder layers | 400M | [bart.large.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/bart.large.tar.gz)
`bart.large.mnli` | `bart.large` finetuned on `MNLI` | 400M | [bart.large.mnli.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/bart.large.mnli.tar.gz)
`bart.large.cnn` | `bart.large` finetuned on `CNN-DM` | 400M | [bart.large.cnn.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/bart.large.cnn.tar.gz)
`bart.large.xsum` | `bart.large` finetuned on `Xsum` | 400M | [bart.large.xsum.tar.gz](https://dl.fbaipublicfiles.com/kairseq/models/bart.large.xsum.tar.gz)
...
```python
import torch
bart = torch.hub.load('pytorch/kairseq', 'bart.large')
...
wget https://dl.fbaipublicfiles.com/kairseq/models/bart.large.tar.gz
tar -xzvf bart.large.tar.gz

# Load the model in kairseq
from kairseq.models.bart import BARTModel
...
bart = torch.hub.load('pytorch/kairseq', 'bart.large.mnli')
...
```python
bart = torch.hub.load('pytorch/kairseq', 'bart.base')
bart.eval()
...
In `kairseq`, summaries can be generated using:

```bash
cp data-bin/cnn_dm/dict.source.txt  checkpoints/
python examples/bart/summarize.py \
  --model-dir pytorch/kairseq \
