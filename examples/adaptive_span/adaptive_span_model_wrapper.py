...
@dataclass
class AdaptiveSpanSmallConfig(KairseqDataclass):
    # defaults come from https://github.com/khulnasoft/adaptive-span/blob/master/experiments/enwik8_small.sh
    vocab_size: int = 50
    d_model: int = 256
    n_head: int = 4
    d_inner: int = 1024
...
class AdaptiveSpanTransformer(KairseqLanguageModel):
    @classmethod
...
class AdaptiveSpanDecoder(KairseqIncrementalDecoder):
