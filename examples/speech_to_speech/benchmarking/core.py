...
from kairseq.models.text_to_speech.vocoder import CodeHiFiGANVocoder
...
from kairseq_cli.generate import get_symbols_to_strip_from_output
...
class Processing(BenchmarkingBase):
    """Class similar to kairseq_cli/generate.py. Supports ASR, MT and ST model inference"""
