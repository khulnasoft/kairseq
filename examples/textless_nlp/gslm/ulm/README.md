...
Here you can find links to the pre-trained ULMs and instructions on training new models using kairseq. At the end of the page, we also share how to run sampling for those models and provide pointers to the transcribed prompts we used.
...
As an ULM, we train a standard kairseq Transformer LM. Assuming 8 GPUs used for training, a good starting point for an ULM training would be:
```bash
	kairseq-train data-bin/ \
