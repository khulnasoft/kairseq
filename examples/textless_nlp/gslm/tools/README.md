...
PYTHONPATH=${KAIRSEQ_ROOT}:${KAIRSEQ_ROOT}/examples/textless_nlp/gslm/unit2speech python ${KAIRSEQ_ROOT}/examples/textless_nlp/gslm/tools/resynthesize_speech.py \
    --feature_type $TYPE \
