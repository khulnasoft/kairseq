...
Three packages are required in addition to kairseq, they are installable with pip:
```bash 
...
To get unit trascripts of the speech data we rely on the preprocessing steps of [GSLM](https://github.com/pytorch/kairseq/tree/main/examples/textless_nlp/gslm/speech2unit/) work.
