...
from kairseq.modules import EMAModule, EMAModuleConfig
from kairseq.models import (
    KairseqEncoder,
    KairseqEncoderModel,
    register_model,
)
from kairseq.models.roberta.model import RobertaLMHead, RobertaClassificationHead
from kairseq.models.transformer import TransformerEncoder, TransformerConfig
...
@dataclass
class Data2VecTextConfig(KairseqDataclass):
...
class Data2VecTextModel(KairseqEncoderModel):
...
class Data2VecTextEncoder(KairseqEncoder):
