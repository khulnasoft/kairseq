...
from kairseq import checkpoint_utils, tasks
...
from kairseq.models.wav2vec.wav2vec2 import MASKING_DISTRIBUTION_CHOICES
from kairseq.modules import TransposeLast
...
@dataclass
class AudioClassificationConfig(KairseqDataclass):
...
class AudioClassificationModel(BaseKairseqModel):
    ...
    @classmethod
    def build_model(cls, cfg: AudioClassificationConfig, task: KairseqTask):
