...
from kairseq.tasks.audio_pretraining import AudioPretrainingConfig, AudioPretrainingTask
from kairseq.tasks.masked_lm import MaskedLMConfig, MaskedLMTask
...
@dataclass
class MultimodalPretrainingConfig(KairseqDataclass):
...
class MultimodalPretrainingTask(KairseqTask):
    """ """
