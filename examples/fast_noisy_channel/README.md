...
For training Transformer models in kairseq for machine translation, refer to instructions [here](https://github.com/pytorch/kairseq/tree/main/examples/translation)

For training Transformer models in kairseq for language modeling, refer to instructions [here](https://github.com/pytorch/kairseq/tree/main/examples/language_model)

### Generation with Language Model for German-English translation with kairseq

Here are instructions to generate using a direct model and a target-side language model.

Note:
- Download and install kairseq as per instructions [here](https://github.com/pytorch/kairseq)
...
lenpen=0.16
lm_wt=0.14
kairseq-generate ${binarized_data} \
    ...
    --batch-size 10
```
### Noisy Channel Generation for German-English translation with kairseq
...
### Fast Noisy Channel Generation for German-English translation with kairseq
...
cd $KAIRSEQ
SCRIPTS=$KAIRSEQ/mosesdecoder/scripts
if [ ! -d "${SCRIPTS}" ]; then
