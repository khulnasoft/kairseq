...
from kairseq.sequence_generator import EnsembleModel
...
class NoisyChannelSequenceGenerator(object):
    def __init__(
        ...
        Args:
            ...
            tgt_dict (~kairseq.data.Dictionary): target dictionary
            src_dict (~kairseq.data.Dictionary): source dictionary
            ...
            channel_models (List[~kairseq.models.KairseqModel]): ensemble of models
            ...
            lm_models (List[~kairseq.models.KairseqModel]): ensemble of models
                generating text in the target language
            lm_dict (~kairseq.data.Dictionary): LM Model dictionary
