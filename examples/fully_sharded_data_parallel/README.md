...
by [fairscale](https://github.com/khulnasoft/fairscale/).
...
FSDP is fully supported in kairseq via the following new arguments:
...
FSDP currently has several limitations compared to kairseq's default DDP backend (PyTorch DDP):
...
Follow the [instructions here](https://github.com/pytorch/kairseq/blob/main/examples/roberta/README.pretraining.md#1-preprocess-the-data)
...
**Requirements:**
- Install the latest master version of fairscale: `pip install git+https://github.com/khulnasoft/fairscale.git@master`
...
OMP_NUM_THREADS=20 CUDA_VISIBLE_DEVICES=0 \
    kairseq-train data-bin/wikitext-103-roberta-bpe-bin \
...
```
(...)
2021-03-08 12:29:51 | INFO | kairseq_cli.train | num. model params: 13,110,865,920 (num. trained: 13,110,865,920)
(...)
2021-03-08 12:29:51 | INFO | kairseq_cli.train | training on 1 devices (GPUs/TPUs)
2021-03-08 12:29:51 | INFO | kairseq_cli.train | max tokens per GPU = None and batch size per GPU = 8
(...)
...
2021-03-08 12:33:12 | INFO | kairseq.trainer | NOTE: gradient overflow detected, ignoring gradient, setting loss scale to: 2.0
2021-03-08 12:33:51 | INFO | kairseq.trainer | NOTE: gradient overflow detected, ignoring gradient, setting loss scale to: 1.0
...
2021-03-08 12:41:04 | INFO | kairseq_cli.train | Stopping training due to num_updates: 10 >= max_update: 10
2021-03-08 12:41:04 | INFO | kairseq_cli.train | begin validation on "valid" subset
...
2021-03-08 12:43:15 | INFO | kairseq_cli.train | end of epoch 1 (average epoch stats below)
...
2021-03-08 12:43:15 | INFO | kairseq_cli.train | done training in 798.6 seconds
```
...
```
(...)
2021-03-08 18:04:09 | INFO | kairseq_cli.train | num. model params: 13,110,865,920 (num. trained: 13,110,865,920)
(...)
2021-03-08 18:04:09 | INFO | kairseq_cli.train | training on 8 devices (GPUs/TPUs)
2021-03-08 18:04:09 | INFO | kairseq_cli.train | max tokens per GPU = None and batch size per GPU = 8
(...)
Adam Optimizer #0 is created with AVX2 arithmetic capability.
Config: alpha=0.000100, betas=(0.900000, 0.980000), weight_decay=0.000000, adam_w=1
(...)
...
2021-03-08 18:06:21 | INFO | kairseq.trainer | NOTE: gradient overflow detected, ignoring gradient, setting loss scale to: 2.0
2021-03-08 18:06:56 | INFO | kairseq.trainer | NOTE: gradient overflow detected, ignoring gradient, setting loss scale to: 1.0
...
2021-03-08 18:12:19 | INFO | kairseq_cli.train | Stopping training due to num_updates: 10 >= max_update: 10
2021-03-08 18:12:19 | INFO | kairseq_cli.train | begin validation on "valid" subset
...
2021-03-08 18:12:45 | INFO | kairseq_cli.train | end of epoch 1 (average epoch stats below)
...
2021-03-08 18:12:45 | INFO | kairseq_cli.train | done training in 509.9 seconds
```
