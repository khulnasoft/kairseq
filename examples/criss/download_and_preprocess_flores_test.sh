...
if [[ -f flores ]]; then
  ...
  git clone https://github.com/khulnasoft/flores
fi

mkdir -p $DATA
download_data $DATA/wikipedia_en_ne_si_test_sets.tgz "https://github.com/khulnasoft/flores/raw/master/data/wikipedia_en_ne_si_test_sets.tgz"
pushd $DATA
pwd
