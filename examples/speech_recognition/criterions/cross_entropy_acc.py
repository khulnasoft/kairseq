...
class CrossEntropyWithAccCriterion(KairseqCriterion):
    ...
    def forward(self, model, sample, reduction="sum", log_probs=True):
        ...
        This is similar to CrossEntropyCriterion in kairseq, but also
        ...
        TODO:
            * Currently this Criterion will only work with LSTMEncoderModels or
            KairseqModels which have decoder, or Models which return TorchTensor
            as net_output.
            We need to make a change to support all KairseqEncoder models.
        """
