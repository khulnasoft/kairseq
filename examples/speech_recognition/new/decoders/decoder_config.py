...
from kairseq.dataclass.constants import ChoiceEnum
from omegaconf import MISSING


DECODER_CHOICES = ChoiceEnum(["viterbi", "kenlm", "kairseqlm"])


@dataclass
class DecoderConfig(KairseqDataclass):
...
@dataclass
class FlashlightDecoderConfig(KairseqDataclass):
    nbest: int = field(
        default=1,
