...
from kairseq.models.kairseq_model import KairseqModel
from kairseq.utils import apply_to_sample
...
try:
    ...
    warnings.warn(
        ...
        "Please install from "
        "https://github.com/khulnasoft/flashlight/tree/master/bindings/python"
    )
    LM = object
    LMState = object
...
class KairseqLM(LM):
    def __init__(self, dictionary: Dictionary, model: KairseqModel) -> None:
        super().__init__()
    ...
    def start(self, start_with_nothing: bool) -> LMState:
        ...
        self.states[state] = KairseqLMState(
    ...
    def score(
        ...
        def trim_cache(targ_size: int) -> None:
            while len(self.stateq) > targ_size:
                ...
                rem_st = KairseqLMState(rem_st.prefix, None, None)
        ...
        if outstate not in self.states and not no_cache:
            ...
            self.states[outstate] = KairseqLMState(prefix, incr_state, None)
...
class KairseqLMDecoder(BaseDecoder):
    def __init__(self, cfg: FlashlightDecoderConfig, tgt_dict: Dictionary) -> None:
        super().__init__(tgt_dict)
        ...
        self.lm = KairseqLM(self.word_dict, model)
