...
from kairseq import checkpoint_utils, distributed_utils, progress_bar, tasks, utils
...
from kairseq.logging.meters import StopwatchMeter, TimeMeter
from kairseq.logging.progress_bar import BaseProgressBar
...
@dataclass
class InferConfig(KairseqDataclass):
    task: Any = None
...
class InferenceProcessor:
    ...
    def optimize_model(self, model: KairseqModel) -> None:
    ...
    def load_model_ensemble(self) -> Tuple[List[KairseqModel], KairseqDataclass]:
