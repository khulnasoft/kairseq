...
# Speech Recognition
`examples/speech_recognition` is implementing ASR task in Kairseq, along with needed features, datasets, models and loss functions to train and infer model described in [Transformers with convolutional context for ASR (Abdelrahman Mohamed et al., 2019)](https://arxiv.org/abs/1904.11660).


## Additional dependencies
On top of main kairseq dependencies there are couple more additional requirements.
...
## Using flashlight (previously called [wav2letter](https://github.com/khulnasoft/wav2letter)) components
[flashlight](https://github.com/khulnasoft/flashlight) now has integration with kairseq. Currently this includes:
