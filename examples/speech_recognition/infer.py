...
import numpy as np
import torch
from kairseq import checkpoint_utils, options, progress_bar, tasks, utils
...
output units",
    ...
    parser.add_argument(
        "--w2l-decoder",
        choices=["viterbi", "kenlm", "kairseqlm"],
...
def main(args, task=None, model_state=None):
    ...
    def build_generator(args):
        ...
        elif w2l_decoder == "kairseqlm":
            from examples.speech_recognition.w2l_decoder import W2lKairseqLMDecoder

            return W2lKairseqLMDecoder(args, task.target_dictionary)
        else:
            print(
                "only flashlight decoders with (viterbi, kenlm, kairseqlm) options are supported at the moment"
            )
