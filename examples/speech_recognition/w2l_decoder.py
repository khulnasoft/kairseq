...
try:
    ...
    warnings.warn(
        "flashlight python bindings are required to use this functionality. Please install from https://github.com/khulnasoft/flashlight/tree/master/bindings/python"
    )
    LM = object
    LMState = object
...
KairseqLMState = namedtuple("KairseqLMState", ["prefix", "incremental_state", "probs"])
...
class W2lKairseqLMDecoder(W2lDecoder):
    def __init__(self, args, tgt_dict):
        super().__init__(args, tgt_dict)
