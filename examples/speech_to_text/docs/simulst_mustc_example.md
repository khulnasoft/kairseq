...
[SimulEval](https://github.com/khulnasoft/SimulEval) is used for evaluation.
...
simuleval \
    --agent ${KAIRSEQ}/examples/speech_to_text/simultaneous_translation/agents/kairseq_simul_st_agent.py
...
```bash
python ${KAIRSEQ}/examples/speech_to_text/seg_mustc_data.py \
