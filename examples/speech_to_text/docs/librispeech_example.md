...
[Download](https://dl.fbaipublicfiles.com/kairseq/s2t/librispeech_vocab_unigram10000.zip) our vocabulary files
if you want to use our pre-trained models.

## Training
```bash
kairseq-train ${LS_ROOT} --save-dir ${SAVE_DIR} \
...
for SUBSET in dev-clean dev-other test-clean test-other; do
  kairseq-generate ${LS_ROOT} --config-yaml config.yaml --gen-subset ${SUBSET} \
...
```bash
kairseq-interactive ${LS_ROOT} --config-yaml config.yaml --task speech_to_text \
...
|---|---|---|---|---|---|---|
| s2t_transformer_s | 30M | 3.8 | 8.9 | 4.4 | 9.0 | [Download](https://dl.fbaipublicfiles.com/kairseq/s2t/librispeech_transformer_s.pt) |
| s2t_transformer_m | 71M | 3.2 | 8.0 | 3.4 | 7.9 | [Download](https://dl.fbaipublicfiles.com/kairseq/s2t/librispeech_transformer_m.pt) |
| s2t_transformer_l | 268M | 3.0 | 7.5 | 3.2 | 7.5 | [Download](https://dl.fbaipublicfiles.com/kairseq/s2t/librispeech_transformer_l.pt) |
