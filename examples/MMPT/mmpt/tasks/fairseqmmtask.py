...
"""
make a general kairseq task for MM pretraining.
"""
...
class KairseqMMTask(LegacyKairseqTask):
    @staticmethod
    def add_args(parser):
        ...
        parser.add_argument(
            "taskconfig",
            metavar="FILE",
            help=("taskconfig to load all configurations" "outside kairseq parser."),
        )

    @classmethod
    def setup_task(cls, args, **kwargs):
        return KairseqMMTask(args)
    ...
    def load_dataset(self, split, **kwargs):
        ...
        if split_map[split] is not None:
            self.datasets[split] = KairseqMMDataset(split_map[split])
