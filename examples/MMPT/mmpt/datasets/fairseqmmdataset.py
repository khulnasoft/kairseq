...
"""
TODO (huxu): kairseq wrapper class for all dataset you defined: mostly MMDataset.
"""
...
class KairseqMMDataset(KairseqDataset):
    """
    A wrapper class for MMDataset for kairseq.
    """
