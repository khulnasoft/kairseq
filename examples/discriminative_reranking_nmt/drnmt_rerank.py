...
from kairseq import checkpoint_utils, options, utils


logger = logging.getLogger("kairseq_cli.drnmt_rerank")
...
def parse_kairseq_gen(filename, task):
    source = {}
    hypos = {}
    scores = {}
...
def decode_rerank_scores(args):
    ...
    src, hyp, mt_scores = parse_kairseq_gen(args.in_text, task)
    model_scores = {}
...
def cli_main():
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="text from kairseq-interactive output, containing source sentences and hypotheses",
    )
