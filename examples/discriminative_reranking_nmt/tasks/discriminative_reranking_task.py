...
@dataclass
class DiscriminativeRerankingNMTConfig(KairseqDataclass):
...
class DiscriminativeRerankingNMTTask(KairseqTask):
    """
    ...
    def build_model(self, cfg: KairseqDataclass, from_checkpoint: bool = False):
