...
from kairseq.models.roberta.model import RobertaClassificationHead
...
@dataclass
class DiscriminativeNMTRerankerConfig(KairseqDataclass):
...
class DiscriminativeNMTReranker(BaseKairseqModel):
    @classmethod
