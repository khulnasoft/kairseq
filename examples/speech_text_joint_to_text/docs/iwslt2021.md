...
#### Prepare
-   Please follow the data preparation in [speech-to-text](https://github.com/pytorch/kairseq/blob/main/examples/speech_to_text/docs/mtedx_example.md) with option "--use-audio-input" for raw audio tsv files. 
