# Joint Speech Text training in Kairseq
An extension of Kairseq s2t project with the speech to text task enhanced by the co-trained text to text mapping task. More details about Kairseq s2t can be found [here](../speech_to_text/README.md)

## Examples
Examples of speech text joint training in kairseq
