...
from kairseq.models.speech_to_text import Wav2VecEncoderWithAdaptor
from kairseq.models.speech_to_text.xm_transformer import (
    set_default_adaptor_args,
    set_default_w2v_encoder_args,
    need_finetuning
)
from kairseq.models.transformer import TransformerEncoder, TransformerDecoder
from kairseq.models.wav2vec import TransformerSentenceEncoderLayer
...
class SharedEncoder(KairseqEncoder):
...
class StackedWav2VecEncoderWithAdaptor(KairseqEncoder):
    def __init__(
        self,
        wav2vec_enc,
        mbart_enc_layers,
