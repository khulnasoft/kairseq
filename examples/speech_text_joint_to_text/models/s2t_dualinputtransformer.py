...
from kairseq.models.speech_to_text import (
    TransformerDecoder,
...
class SpeechEoSEncoder(KairseqEncoder):
...
class DualInputEncoder(KairseqEncoder):
    def __init__(
        self,
        args,
        spch_encoder,
...
class TransformerMultiInputDecoder(KairseqDecoder):
    def __init__(
        self,
        dictionary,
        spch_decoder,
...
class DualInputS2TTransformerModel(KairseqEncoderDecoderModel):
