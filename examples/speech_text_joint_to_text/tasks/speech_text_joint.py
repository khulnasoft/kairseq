...
from kairseq.data.iterators import GroupedEpochBatchIterator
from kairseq.data.audio.multi_modality_dataset import (
...
from kairseq.data.audio.speech_to_text_joint_dataset import (
    S2TJointDataConfig,
    SpeechToTextJointDatasetCreator,
)
from kairseq.tasks import register_task
from kairseq.tasks.speech_to_text import SpeechToTextTask
