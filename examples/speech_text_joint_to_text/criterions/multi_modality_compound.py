...
from kairseq.criterions.ctc import CtcCriterion, CtcCriterionConfig
from kairseq.criterions.label_smoothed_cross_entropy import (
...
class SpeechTextPreTrainCompoundCriterion(KairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
